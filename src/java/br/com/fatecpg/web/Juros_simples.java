 ...
 * @author Usuário
 */
@WebServlet(name = "Juros_Simples", urlPatterns = {"/juros_simples.html"})
public class Juros_simples extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h2> Para calcularmos o Juros Simples necessitamos de: </h2>");
            out.println("<form action='resposta_simples.html'>"
                    + "Valor do Capital: "
