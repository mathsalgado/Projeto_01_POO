...
public class Home extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<tr>");
            out.println("<td> Neste Projeto, temos como objetivo permitir <br>  "
                    + "ao Usuário a realização do cálculo do Juros <br>"
                    + " Simples e Composto de uma Aplicação Financeira</td> ");
            out.println("</tr>");
            out.println("</table>");
